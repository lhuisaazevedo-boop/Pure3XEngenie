...
A documentação oficial começará a ser desenvolvida a partir da versão v0.1.5 Alpha, acompanhando a evolução dos módulos e funcionalidades do projeto.

Novos documentos serão adicionados continuamente conforme o desenvolvimento da engine.
...
A documentação será mantida atualizada a cada nova versão oficial.
